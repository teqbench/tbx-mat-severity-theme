...
Example configuration (the actual file may differ from this snapshot):
...
```json
{
    ...
    "packages": {
        ".": {
            "package-name": "@teqbench/tbx-mat-severity-theme",
...
Example manifest (the actual version will differ):
